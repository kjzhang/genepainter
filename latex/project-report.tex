...
Detailed below are the specifics of our implementation.
...
\caption{Mona Lisa, unsupervised genetic algorithm.}
\label{evolutionfig}
\end{center}
\end{figure*}
...
\caption{Mona Lisa, supervised genetic algorithm.}
\label{evolutionfig}
\end{center}
\end{figure*}
...
\caption{Picasso, supervised genetic algorithm.}
\label{evolutionfig}
\end{center}
\end{figure*}
